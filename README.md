...
نسخهٔ جاری: ۱.۳.۵ — شامل جداسازی صفحه دانشجویان چندآزمونی در گزارشات، بهبود سیستم ارسال خودکار نوتیفیکیشن با جلوگیری از ارسال تکراری، بهبود تقویم جلسات (نمایش کم‌رنگ آزمون‌های گذشته)، اضافه شدن آمار ساختمان‌ها به برچسب پاکت تستی، بهبود تنظیمات گزارش شماره صندلی، اصلاح نمایش نام درس در فهرست حضور و غیاب و اضافه/حذف دروس دانشجویان چندآزمونی در برچسب پاکت سوالات.
