...
### 🐛 رفع باگ‌ها
- **رفع مشکل لایسنس در اولین اجرا**: افزودن درخواست خودکار لایسنس موقت
  - اگر توکن لایسنس خالی باشد، سیستم خودکار به سرور لایسنس درخواست می‌فرستد
  - توکن دریافتی در دیتابیس ذخیره می‌شود
  - حذف خطای "License token is missing" در اولین اجرا
- **بهبود Audit Log**: ثبت درخواست‌های لایسنس خودکار
