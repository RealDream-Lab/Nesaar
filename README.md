...
- همسان‌سازی کامل عرض و حاشیه در گزارش‌های «لیست منشی جلسه» و «ملزومات اتاق تکثیر» برای جلوگیری از اختلاف ترازبندی.
- افزایش حاشیه افقی چاپ در گزارش اتاق تکثیر تا محتوا از لبه صفحه فاصله ایمن داشته باشد.
- بهبود گردش چاپ گزارش‌ها و حذف وابستگی به page-break اضافی برای جلوگیری از صفحات خالی ناخواسته.
