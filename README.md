...
- بهبود رابط کاربری داشبورد مدیریت با اضافه کردن دکمه بازگشت به صفحه اصلی.
- بازسازی بخش ابزارها با اضافه کردن دکمه‌های جدید برای به‌روزرسانی آزمون‌های کتبی، الکترونیکی و پایگاه داده.
- اضافه کردن دکمه "عوامل برگزاری آزمون" برای مدیریت عوامل برگزاری.
- کامنت کردن دکمه ماژول مراقبین در هدر و حذف فایل‌های مرتبط برای ساده‌سازی رابط کاربری.
- به‌روزرسانی نسخه سرویس‌ورکر به ۳.۴.۰.

### تغییرات نسخه ۳.۳.۱

- حذف کامنت‌های غیرضروری از فایل‌های JavaScript برای کاهش حجم کد.
- اضافه کردن دکمه "ماژول مراقبین" به داشبورد مدیریت با نمایش پیام اطلاعاتی.
