...
نسخهٔ جاری: ۰.۵.۵ — شامل بهبودهای ظاهری و همگونی UI در ماژول مراقبین (مودال جلسات هم‌شکل با مودال محدودیت‌ها)، بهینه‌سازی رنگ‌بندی جلسات گذشته/آینده، به‌روزرسانی Service Worker و رفع چند باگ جزئی.
