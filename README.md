...
نسخهٔ جاری: ۰.۸.۰ — بهبود عملکرد ماژول مراقبین؛ پس از اجرای موفق هر کدام از چینش‌های خودکار (روزانه یا پراکنده) کارت آمار جلسات (`sessionStatsCard`) نمایش داده می‌شود. Service Worker نیز اکنون با `exam-seat-v0.8.0` همگام شده است.
