...
### تغییرات نسخه ۳.۱.۰
- افزودن قابلیت "صورتجلسه آزمون‌ها" برای چاپ A4 عمودی (Portrait):
   - چاپ بهینه برای A4 عمودی با سربرگ دانشگاه و توضیحات جلسه
   - نمایش 16 درس در هر صفحه و تکرار بلوک امضاها در پایین هر صفحه
   - شماره صفحه فشرده (صفحه X از Y) در پایین هر شیت
   - بهبود تبدیل ارقام به فارسی و اصلاح جهت‌بندی سال تحصیلی (BIDI)

### تغییرات نسخه ۳.۰.۱
- اضافه شدن قابلیت چاپ شماره صندلی: گزارش چاپی دو‌ستونه با تنظیمات جدید (مرتب‌سازی بر اساس نام خانوادگی، وسط‌چین کردن ستون "صندلی"، سرستون‌های وسط‌چین و بهبود اندازه/وزن تاریخ/ساعت).

### تغییرات نسخه ۳.۰.۰
- اضافه شدن گزارش‌های متنوع به پنل مدیریت و افزوده شدن نمودارهای تحلیلی (Chart.js) در بخش گزارش‌ها.
- به‌روزرسانی مستندات و افزودن پیش‌نمایش مودال برای نمودارها.
