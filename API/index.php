...
// دریافت ورودی (بهتر از POST برای اطلاعات حساس)
$student_id = $_POST['student_id'] ?? $_GET['student_id'] ?? '';
$national_id = $_POST['national_id'] ?? $_GET['national_id'] ?? '';
// کوئری امن
$sql = "
SELECT 
...
// بررسی وجود نتیجه
if (empty($results)) {
    echo json_encode(['error' => 'اطلاعاتی برای این شماره دانشجویی و شماره ملی (شماره شناسنامه) پیدا نشد']);
    exit;
}
