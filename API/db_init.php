...
VALUES
('1100001', 'پایگاه داده‌ها', '1404/07/24', '09:30', 'الکترونیکی', 'تستی'),
...
('1100006', 'زبان تخصصی', '1404/07/24', '12:30', 'الکترونیکی', 'تستی'),
('1100007', 'مدارهای منطقی', '1404/08/23', '08:30', 'کتبی', 'تشریحی'),
('1100008', 'مبانی کامپیوتر و برنامه‌سازی', '1404/08/12', '09:00', 'الکترونیکی', 'تستی'),
('1100009', 'ریاضی گسسته', '1404/07/24', '11:00', 'کتبی', 'تشریحی'),
('1100010', 'سیستم عامل', '1404/07/17', '14:30', 'الکترونیکی', 'تستی'),
('1100011', 'شبکه‌های کامپیوتری', '1404/07/20', '10:30', 'الکترونیکی', 'تستی'),
('1100012', 'مهندسی نرم‌افزار', '1404/07/22', '08:30', 'الکترونیکی', 'تستی'),
('1100013', 'طراحی الگوریتم‌ها', '1404/07/25', '13:00', 'کتبی', 'تستی و تشریحی');

INSERT INTO exam_seats (student_id, course_code, seat_number, building, class_name, seat_row)
VALUES
    ('970100001', '1100001', 5, 'ساختمان پروفسور ستاره', 'کلاس 201', 1),
    ('970100001', '1100002', 9, 'ساختمان پروفسور ستاره', 'کلاس 204', 2),
    ('970100001', '1100003', 14, 'ساختمان پروفسور ستاره', 'کلاس 206', 3),
