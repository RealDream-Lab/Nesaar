        ...
        const attachModal = (exam, status) => {
            return () => {
                ...
                Swal.fire({
                    ...
                    html: `
                        <div style="text-align:justify;direction:rtl;line-height:1.9;font-size:1.05em;">
                            آزمون این درس راس ساعت ${toPersianDigits(exam.exam_time)} روز ${exam.exam_day} ${toPersianDigits(exam.exam_date)} به صورت ${escapeHtml(exam.course_type)} و ${escapeHtml(exam.exam_type)} برگزار خواهد شد.<br><br>
