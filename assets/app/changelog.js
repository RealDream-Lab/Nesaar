...
window.CHANGELOG = {
  "1.6.5": {
    date: "۱۴۰۴/۱۱/۲۰",
    changes: [
      "گروه‌بندی تاریخ‌های تقویم بر اساس هفتهٔ تقویمی و رفع نمایش نادرست.",
      "گسترش تقویم برای نمایش پنجشنبه و جمعه در صورت وجود آزمون.",
      "بهبود پیام خطا در APIهای گزارش‌گیری و ثبت خطا در لاگ سرور.",
      "سخت‌گیری بیشتر در احراز داخلی برای جلوگیری از سوءاستفاده هدرهای غیرمجاز.",
    ],
  },
  "1.6.0": {
    date: "۱۴۰۴/۱۱/۱۰",
    changes: [
      "افزودن کارت آمار پوش نوتیفیکیشن به داشبورد (دستی، زمان‌بندی شده، خودکار)",
      "نمایش تعداد ارسال، تحویل شده و ناموفق برای هر نوع پوش",
      "نمایش تعداد مشترکین فعال پوش (دانشجو/مراقب)",
      "افزودن آخرین به‌روزرسانی به کارت‌های آمار بازدید و پوش",
      "گروه‌بندی هوشمند ارسال‌های همزمان با batch_id",
    ],
  },
  "1.5.5": {
    date: "۱۴۰۴/۱۰/۱۸",
