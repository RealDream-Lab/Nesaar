...
-- ۱۰ عنوان جدید برای دانشجوی 970100001 در مهر ۱۴۰۴
INSERT INTO courses (course_code, course_name, exam_date, exam_time, exam_type, course_type)
VALUES
('1100004', 'ریاضیات عمومی ۱', '1404/07/02', '08:00', 'حضوری', 'نظری'),
('1100005', 'فیزیک ۱', '1404/07/04', '10:00', 'حضوری', 'نظری'),
('1100006', 'زبان تخصصی', '1404/07/07', '13:30', 'حضوری', 'نظری'),
('1100007', 'مدارهای منطقی', '1404/07/09', '15:00', 'حضوری', 'نظری'),
('1100008', 'مبانی کامپیوتر و برنامه‌سازی', '1404/07/12', '09:00', 'حضوری', 'عملی'),
('1100009', 'ریاضی گسسته', '1404/07/14', '11:00', 'حضوری', 'نظری'),
('1100010', 'سیستم عامل', '1404/07/17', '14:30', 'حضوری', 'نظری'),
('1100011', 'شبکه‌های کامپیوتری', '1404/07/19', '10:30', 'حضوری', 'نظری'),
('1100012', 'مهندسی نرم‌افزار', '1404/07/22', '08:30', 'حضوری', 'نظری'),
('1100013', 'طراحی الگوریتم‌ها', '1404/07/25', '13:00', 'حضوری', 'نظری');

-- تخصیص شماره صندلی برای دروس جدید دانشجوی 970100001
INSERT INTO exam_seats (student_id, course_code, seat_number, building, class_name, seat_row)
VALUES
...
('970100001', '1100008', 7, 'ساختمان B', 'کلاس 101', 2),
('970100001', '1100009', 10, 'ساختمان B', 'کلاس 102', 2),
('970100001', '1100010', 18, 'ساختمان C', 'کلاس 301', 3),
('970100001', '1100011', 11, 'ساختمان C', 'کلاس 302', 2),
('970100001', '1100012', 16, 'ساختمان D', 'کلاس 401', 2),
('970100001', '1100013', 6, 'ساختمان D', 'کلاس 402', 1);