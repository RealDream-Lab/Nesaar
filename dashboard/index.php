                        ...
                        <div class="card"
                            ...
                            <div class="card-body p-3">
                                ...
                                <div class="d-flex gap-4 mb-3">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="pushFilterMode"
                                            id="pushFilterModeSession" value="session" checked>
                                        <label class="form-check-label" for="pushFilterModeSession"
                                            style="font-weight:500;">ارسال بر اساس جلسه</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="pushFilterMode"
                                            id="pushFilterModeCourse" value="course">
                                        <label class="form-check-label" for="pushFilterModeCourse"
                                            style="font-weight:500;">ارسال بر اساس درس</label>
                                    </div>
                                </div>

                                <!-- Session Mode Filters -->
                                <div id="pushSessionModeContainer" class="row g-2">
                                    <div class="col-12 col-md-6">
                                        ...
                                        <small class="text-muted">بدون انتخاب = همه دانشجویان</small>
                                    </div>
                                    <div class="col-12 col-md-6">
                                        ...
                                        <small class="text-muted">بدون انتخاب = همه جلسات تاریخ‌های انتخابی</small>
                                    </div>
                                </div>

                                <!-- Course Mode Filters -->
                                <div id="pushCourseModeContainer" class="row g-2" style="display:none;">
                                    <div class="col-12">
                                ...
                                <div class="mt-3 d-flex align-items-center gap-3">
                                    ...
                                    <span id="pushFilterCount" style="color:#1976d2;font-weight:600;"></span>
                                </div>

                                <!-- Target Audience Count -->
                                <div id="pushTargetCount" class="mt-2 p-2"
                                    style="background:rgba(76,175,80,0.1);border-radius:6px;display:none;">
                                    <span style="font-size:0.9rem;">📊 جامعه هدف: <strong
                                            id="pushTargetNumber">۰</strong> دانشجو</span>
                                </div>
                            </div>
                        </div>
                    </div>
